...
Este directorio contiene el código fuente y la configuración para el servicio **Matchmaker** del proyecto Trascendence.

`src/matchmaker.ts`: Archivo main.
...
*   **Variables de Entorno:**
    *   Nombre del container: **matchmaker**
    *   Archivo **.env**:
