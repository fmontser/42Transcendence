...
Este directorio contiene el código fuente y la configuración para el servicio **Webserver** del proyecto Trascendence.

`src/webserver.ts`: Archivo main.
...
*   **Variables de Entorno:**
    *   Nombre del container: **webserver**
    *   Archivo **.env**:
