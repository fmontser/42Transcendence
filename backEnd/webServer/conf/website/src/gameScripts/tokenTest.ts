...
/* 
	con websocket:
		...
		- enviar como parametro al matchmaker
		- matchmaker obtiene el token con algo asi:
		...
		- hacer la validacion y obtener el user_id contra le userManagement:

			const respuesta = await fetch("http://userManagement:3000/get/profile_session", {
			method: 'GET',
			headers: {
				'Cookie': nombreCookie=valorCookie; otraCookie=otroValor
